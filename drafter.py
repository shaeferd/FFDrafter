...
class AutoDraft():
	...
	def __init__(self, my_ranks):

		self.my_ranks = my_ranks
		self.my_team = []
		self.my_starters = []
		self.my_backups = []
		self.round = 0
	...
	def pick_player(self, ranks, player = ''):
		...
		#player = self.my_ranks['Player'][0] #This may not work in person draft. 
...
def main():
	...
	player6 = AutoDraft(avg_ranks.copy())
	player7 = AutoDraft(avg_ranks.copy())
	player8 = AutoDraft(avg_ranks.copy())
	...
	for i in range(16):
		...
		player4.pick_player(avg_ranks.copy())
		print('player 5 picking...')
		player5.pick_player(avg_ranks.copy())
		print('player 6 picking...')
		player6.pick_player(avg_ranks.copy())
		print('player 7 picking...')
		player7.pick_player(avg_ranks.copy())
		print('player 8 picking...')
		player8.pick_player(avg_ranks.copy())
